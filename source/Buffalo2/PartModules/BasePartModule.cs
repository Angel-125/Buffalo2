...
namespace Buffalo2
{
    ...
    public class BasePartModule: PartModule
    {
        ...
        public ConfigNode getPartConfigNode(string classNameOverride = "")
        {
            ...
            if (!string.IsNullOrEmpty(classNameOverride))
                expectedClassName = classNameOverride;
            ...
            for (int index = 0; index < nodes.Length; index++)
            {
                ...
                if (node.HasValue("name"))
                {
                    ...
                    if (moduleName == expectedClassName)
                    {
                        partConfigNode = node;
                        break;
                    }
